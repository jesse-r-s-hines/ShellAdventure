...
# API Docs
You can use any of the standard Python libraries in your puzzle generation functions. The `shell_adventure.api` module also provides some helper classes, such as `File`, and `Permissions`. See [TODO add module docs]() for the full API documentation.
